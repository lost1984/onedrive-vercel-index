...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'admin@gaei2020.onmicrosoft.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/lost1984/onedrive-vercel-index',
    },
    {
      //name: 'Telegram',
